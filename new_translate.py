...
output_directory = "/ocean/projects/bio200049p/zjiang2/Files/spring24/new_translated_conservation"  # Replace with the path to your output directory
...
for _, row in data.iterrows():
    ...
    if output_lines:
        output_file_name = f"{row['Transcript']}_ORF-{orf_type}_Start-{start_index}_End-{end_index}.txt"
